...
public:
	...
	Eigen::ArrayXXd beforeNormalizationElectronDisplacements;					// variable to store the value of electronDisplacement at the previous sampling point
	Eigen::ArrayXXd beforeNormalizationElectronDisplacementsWithPositionChange; // variable to store the value of electronDisplacementWithPositionChange at the previous sampling point
