...
void BoltzmannMC::evaluateNonConstantVariables(){
	...
	beforeNormalizationElectronDisplacements = Eigen::ArrayXXd::Zero(nElectrons, 3);
	beforeNormalizationElectronDisplacementsWithPositionChange = Eigen::ArrayXXd::Zero(nElectrons, 3);
...
void BoltzmannMC::electronDynamicsUntilSynchronization(){
	...
	while ((electronsToBeAdvanced != false).any()){
		...
		beforeNormalizationElectronDisplacements = electronDisplacements;
		beforeNormalizationElectronDisplacementsWithPositionChange = electronDisplacementsWithPositionChange;
	...
	electronDisplacementsSquare += (electronDisplacements - beforeNormalizationElectronDisplacements)*(electronDisplacements - beforeNormalizationElectronDisplacements);
	electronDisplacementsWithPositionChangeSquare += (electronDisplacementsWithPositionChange - beforeNormalizationElectronDisplacementsWithPositionChange)*(electronDisplacementsWithPositionChange - beforeNormalizationElectronDisplacementsWithPositionChange);
